...
class MixtralSparseMoeBlock(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        #     self.random_weight_final_hidden_states = self.get_final_hidden_states(hidden_states, random_weights)
        return final_hidden_states, router_logits

    def get_final_hidden_states(self, hidden_states, router_logits):
